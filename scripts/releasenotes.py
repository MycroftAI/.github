...
class ReleaseNotes:
    ...
    def __len__(self):
        return (
            len(self.features) + len(self.bugfixes) + len(self.tests) + len(self.other)
        )
...
pull_requests = repo.get_pulls(
    state="closed", sort="updated", direction="desc", base=repo.default_branch
)
...
print("\n\n## Numbers:")
print(
    "\tNumber of authors contributing to "
